...
wget - O /etc/slowdns/dns-server https://github.com/FasterExE/VIP-Autoscript/raw/main/slowdns/dns-server; chmod +x dns-server
...
wget https://github.com/FasterExE/VIP-Autoscript/raw/main/slowdns/startdns
chmod +x startdns
...
wget https://github.com/FasterExE/VIP-Autoscript/raw/main/slowdns/server.key
wget https://github.com/FasterExE/VIP-Autoscript/raw/main/slowdns/server.pub
cd /etc/slowdns/
